...
export default tool({
  description: `Run a static PenHub vulnerability-sink scan.

This does not execute exploit payloads. It scans local source files for risky sink patterns and returns compact findings.`,
  args: {
